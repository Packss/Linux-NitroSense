...
from PyQt6.QtCharts import QChart, QLineSeries, QAreaSeries, QChartView
# from PyQt6.QtChart import QChart, QLineSeries, QAreaSeries, QChartView
...
class Ui_NitroSense(object):
    ...
    def setupUI(self, NitroSense):
        ...
        NitroSense.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        ...
        boldfont.setWeight(QtGui.QFont.Weight.Black)
