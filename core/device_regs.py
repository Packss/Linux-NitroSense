...
class ECS_AN515_55(enum.Enum):
    ...
    CPU_TURBO_MODE = "0x08"
    CPU_MANUAL_MODE = "0x0C"
    CPU_MANUAL_SPEED_CONTROL = "0x37"  # Address to set CPU fan GPU_MANUAL_MODE
    ...
    NITROMODE = "0x10"  # Address to change modes
    QUIETMODE = "0x00"
    DEFAULTMODE = "0x00"
    EXTREMEMODE = "0x01"
